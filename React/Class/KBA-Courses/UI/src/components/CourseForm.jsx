  ...
  return (
   <div class="flex justify-center">
         <div class="bg-gray-300 w-[600px] h-[570px] mt-12 font-sans font-semibold  pt-6 pl-12 rounded">
            <p class="text-center text-3xl text-fuchsia-900 font-bold font-serif">   
            ...
            <label for="coursetype">Course Type</label>
             ...
             <button class="bg-fuchsia-900 w-[500px] h-[35px] text-white rounded mt-2 mb-7">Submit</button>
        </div>
        </div>
  )
}
